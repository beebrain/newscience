...
- **ระบบพิเศษ:**
  - **admin_core** — faculty_admin / admin / editor เข้าได้โดยอัตโนมัติ; ใช้กับข่าว, องค์กร, หลักสูตร, Hero Slides, Events, **downloads**, **urgent-popups**, **academic-services**
...
- **แมป URI → slug (สรุป):**
  ...
  - `academic-services` → academic_service (หรือ admin_core) — ข้อมูลการบริการวิชาการ (กำหนดสิทธิ์รายคนได้ที่ **จัดการผู้ใช้ → เลือกผู้ใช้ → สิทธิ์การเข้าถึงระบบ**)
...
- **จัดการเนื้อหา:** news, organization, programs, hero-slides, events, **urgent-popups**, **downloads**, **academic-services** (ข้อมูลการบริการวิชาการ; ลิงก์ยังแสดงใน topbar ด้านขวาเมื่อมีสิทธิ์)
...
| ข้อมูลการบริการวิชาการ (Admin) | Admin\AcademicServices | AcademicServiceModel, AcademicServiceParticipantModel; Views/admin/academic_services/; สิทธิ์กำหนดที่ **จัดการผู้ใช้ → สิทธิ์การเข้าถึงระบบ** (slug: academic_service) หรือมี admin_core |
| ข่าว | Pages::news / Admin\News | NewsModel, NewsImageModel, NewsTagModel |
| หลักสูตร (Program) | ProgramSpaController, Admin\Programs, ProgramAdmin | ProgramModel, ProgramPageModel, ProgramDownloadModel |
...
- ตารางสำคัญ (สรุป): users, user_system_access, systems, news, news_images, news_tags, hero_slides, **urgent_popups**, download_categories, download_documents, **academic_services**, **academic_service_participants**, program_*, events, cert_*, page_views, และตารางใน namespace Edoc
