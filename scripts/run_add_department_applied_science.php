 ...
 * Run: php scripts/run_add_department_applied_science.php
 */
...
$nameTh = 'สาขาวิทยาศาสตร์ประยุกต์';
...
$stmt = $conn->prepare("INSERT INTO departments (name_th, name_en, code, sort_order, status) VALUES (?, 'Applied Science', 'AS', 12, 'active')");
