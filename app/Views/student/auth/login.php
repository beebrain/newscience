...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-box svg { width: 36px; height: 36px; color: #1a1a1a; }
        .header-text { text-align: center; margin-bottom: 1.5rem; }
        .header-text h1 { font-size: 1.5rem; font-weight: 700; margin-bottom: 0.25rem; color: var(--text-main); }
        .header-text p { color: var(--text-muted); font-size: 0.95rem; }
        .form-group { margin-bottom: 1.25rem; }
        .form-label { display: block; font-size: 0.875rem; margin-bottom: 0.5rem; color: #cbd5e1; }
        .form-control {
            width: 100%;
        ...
        .btn-primary:hover { transform: translateY(-1px); box-shadow: 0 8px 15px -3px rgba(234, 179, 8, 0.3); }
        .alert { padding: 1rem; border-radius: 12px; margin-bottom: 1rem; font-size: 0.9rem; }
