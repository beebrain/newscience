...
<style>
    ...
    .portal-hub-card-icon svg {
        width: 28px;
        height: 28px;
    }

    .portal-hub-card--barcode .portal-hub-card-icon {
        background: #fef9c3;
        color: #a16207;
    }

    .portal-hub-card--events .portal-hub-card-icon {
        background: #dbeafe;
        color: #1d4ed8;
    }

    .portal-hub-card--admin .portal-hub-card-icon {
        background: var(--color-gray-200);
        color: var(--color-gray-700);
    }

    .portal-hub-card--admin {
        border-color: var(--color-gray-300);
    }

    .portal-hub-card--admin .portal-hub-card-desc {
        color: var(--color-gray-600);
    }
    ...
    .portal-hub-section-title:first-of-type {
        margin-top: 0;
    }
