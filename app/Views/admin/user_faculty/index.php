            ...
            <div class="faculty-page-header-top">
                <div class="faculty-title-wrap">
                    ...
                    <div>
                        ...
                        <p class="faculty-page-subtitle">จัดการสมาชิกแต่ละคณะด้วยการลากวางหรือกดเพิ่มและลบ — ผู้ใช้ในคณะวิทยาศาสตร์และเทคโนโลยีจะถูกสร้าง/เปิดใช้ใน <a href="<?= base_url('admin/organization') ?>">โครงสร้างองค์กร</a> อัตโนมัติเมื่อบันทึก</p>
                    </div>
                </div>
