        ...
        <form action="<?= base_url('admin/events/update/' . $event['id']) ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="location" name="location" class="form-control"
                    value="<?= old('location', $event['location']) ?>" placeholder="e.g. Main Auditorium">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt" name="excerpt" class="form-control" rows="3"
                    placeholder="Brief description for cards and listings"><?= old('excerpt', $event['excerpt']) ?></textarea>
            </div>

            <div class="form-group">
                <label for="content" class="form-label">Content</label>
                <textarea id="content" name="content" class="form-control" rows="10"
                    placeholder="Full event description (optional)"><?= old('content', $event['content']) ?></textarea>
            </div>
