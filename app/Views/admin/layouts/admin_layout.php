    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav" aria-label="เมนูหลัก">
                ...
                <?php $sidebarRole = session()->get('admin_role');
                if ($sidebarAdminId && ($sidebarRole === 'admin' || $sidebarRole === 'super_admin')): ?>
                        ...
                        <div class="submenu-items">
                            ...
                            <?php if (\App\Libraries\AccessControl::hasAccess($sid, 'exam_admin')): ?>
                                <div class="nav-section">
                                    ...
                                    <div class="nav-item<?= (uri_string() == 'admin/exam' || strpos(uri_string(), 'admin/exam') === 0) ? ' active' : '' ?>">
                                    ...
                                    <div class="nav-item<?= (uri_string() == 'admin/exam/upload' || strpos(uri_string(), 'admin/exam/upload') === 0) ? ' active' : '' ?>">
                                        <a href="<?= base_url('admin/exam/upload') ?>">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
