...
<div class="font-sarabun" style="margin: -1rem; padding: 1.5rem;">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            ?>
                <a href="<?= base_url('dashboard/profile/cv/go-rr-publication') ?>" class="group flex items-center gap-3 bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-all">
                    ...
                    <div>
                        <div class="text-sm font-semibold text-gray-700">กบศ</div>
