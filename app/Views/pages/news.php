                    ...
                    <article class="news-card animate-on-scroll <?= $index < 2 ? 'news-card--featured' : '' ?>">
                        <div class="news-card__image">
                            <?php if (!empty($news['featured_image'])): ?>
                                <img src="<?= base_url(esc($news['featured_image'])) ?>" alt="<?= esc($news['title']) ?>" loading="lazy">
                            <?php else: ?>
                        ...
                        <div class="news-card__content">
                            <h3 class="news-card__title">
                                <a href="<?= base_url('news/' . esc($news['id'])) ?>"><?= esc($news['title']) ?></a>
                            </h3>
                            <?php if (!empty($news['excerpt'])): ?>
                                <p class="news-card__excerpt"><?= esc(mb_substr($news['excerpt'], 0, 80)) ?>...</p>
                            <?php endif; ?>
                            <a href="<?= base_url('news/' . esc($news['id'])) ?>" class="news-card__link">
                                อ่านเพิ่มเติม
