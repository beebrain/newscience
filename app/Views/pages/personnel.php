...
$getCvUrl = function ($person) {
  ...
  return $email !== '' ? base_url('personnel-cv/' . urlencode($email)) : '';
};
        ...
        <div class="personnel-grid-4col">
          <?php if ($headPerson): ?>
            <div class="personnel-grid-cell personnel-grid-cell--chair">
              <?php $headName = $getDisplayName($headPerson);
              $headImg = $getImageUrl($headPerson);
              $headCvUrl = $getCvUrl($headPerson); ?>
              <?php if ($headCvUrl): ?><a href="<?= esc($headCvUrl) ?>" class="team-card-link"><?php endif; ?>
                <div class="team-card animate-on-scroll">
                  <div class="team-card__image-wrap">
                    <?php if ($headImg): ?>
                      ...
                      <div class="team-card__placeholder" style="display:none;"><svg width="48" height="48" viewBox="0 0 24 24" fill="var(--color-gray-500)">
                          <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
                        </svg></div>
                    <?php else: ?>
                      <div class="team-card__placeholder"><svg width="48" height="48" viewBox="0 0 24 24" fill="var(--color-gray-500)">
                          <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
                        </svg></div>
                    <?php endif; ?>
          ...
          ?>
            <div class="personnel-grid-cell" <?= $headPerson ? ' style="grid-column: ' . $col . '; grid-row: ' . $row . ';"' : '' ?>>
              <?php $cvUrl = $getCvUrl($p); ?>
              <?php if ($cvUrl): ?><a href="<?= esc($cvUrl) ?>" class="team-card-link"><?php endif; ?>
                <div class="team-card animate-on-scroll">
                  <div class="team-card__image-wrap">
                    <?php if ($imgUrl): ?>
        ...
        ?>
          <section class="program-content <?= $isFirst ? 'active' : '' ?>" id="program-panel-<?= $progId ?>" data-program-id="<?= $progId ?>" role="tabpanel" aria-labelledby="program-tab-<?= $progId ?>">
            ...
            <div class="personnel-grid-4col">
              <div class="personnel-grid-cell personnel-grid-cell--chair">
                <?php if ($chair): ?>
                  <?php $chairName = $getDisplayName($chair);
                  $imgUrl = $getImageUrl($chair);
                  $chairCvUrl = $getCvUrl($chair); ?>
                  <?php if ($chairCvUrl): ?><a href="<?= esc($chairCvUrl) ?>" class="team-card-link"><?php endif; ?>
                    <div class="team-card animate-on-scroll">
                      <div class="team-card__image-wrap">
                        <?php if ($imgUrl): ?>
