...
class PersonnelModel extends Model
{
    ...
    /**
     * Get personnel by department with user data
     */
    ...
    {
        $select = $this->selectWithUser() . ', departments.name_th as department_name_th, departments.name_en as department_name_en';
    ...
    public function getDepartmentFromPrimaryProgram(int $personnelId): ?int
    {
        ...
        if ($primaryProgram && !empty($primaryProgram['department_id'])) {
            return (int) $primaryProgram['department_id'];
        }
