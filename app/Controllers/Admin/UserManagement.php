...
class UserManagement extends BaseController
{
    ...
    public function ajaxUpdateUser($uid)
    {
        ...
        $data = [
            ...
            'position_th' => $input['position_th'] ?? $user['position_th'] ?? '',
            'position_en' => $input['position_en'] ?? $user['position_en'] ?? '',
            'gf_name' => $input['gf_name'] ?? $user['gf_name'] ?? '',
            'gl_name' => $input['gl_name'] ?? $user['gl_name'] ?? '',
            'tf_name' => $input['tf_name'] ?? $input['th_name'] ?? $user['tf_name'] ?? '',
            'tl_name' => $input['tl_name'] ?? $input['thai_lastname'] ?? $user['tl_name'] ?? '',
