...
class Settings extends BaseController
{
    ...
    public function initDefaults()
    {
        $defaults = [
            ...
            ['philosophy_th', 'วิทยาศาสตร์และเทคโนโลยีเพื่อการพัฒนาท้องถิ่นและประเทศ ด้วยองค์ความรู้ นวัตกรรมและความเป็นหนึ่งเดียวกับชุมชน', 'textarea', 'about', 'ปรัชญา'],
            ['educational_philosophy_th', 'พัฒนาผู้เรียนให้มีความรู้ ทักษะ และนวัตกรรมทางวิทยาศาสตร์และเทคโนโลยี บนพื้นฐานความเป็นหนึ่งเดียวกับชุมชน เพื่อการพัฒนาท้องถิ่นและประเทศ', 'textarea', 'about', 'ปรัชญาการศึกษา'],
            ['vision_th', 'คณะวิทยาศาสตร์และเทคโนโลยีจะเป็นองค์กรแห่งความเป็นหนึ่งเดียว เป็นศูนย์กลางองค์ความรู้และนวัตกรรมทางวิทยาศาสตร์และเทคโนโลยี สร้างบัณฑิตคุณภาพที่มีคุณธรรม จิตอาสา ความรู้ และทักษะวิชาชีพ เพื่อเป็นพลังขับเคลื่อนการพัฒนาท้องถิ่นและชุมชนสู่ความยั่งยืน', 'textarea', 'about', 'วิสัยทัศน์'],
            ...
            ['mission_th', "1. ผลิตบัณฑิตให้เป็นคนดี คนเก่ง มีจิตอาสา พร้อมทั้งทัศนคติที่ดี เป็นพลเมืองดีของสังคม ยึดหลักปรัชญาเศรษฐกิจพอเพียงตามแนวพระราชดำริในการดำเนินชีวิต และมีความสามารถตรงตามความต้องการของตลาดแรงงาน\n2. วิจัย สร้างองค์ความรู้และนวัตกรรม บริการวิชาการที่เน้นพันธกิจสัมพันธ์โดยการ บูรณาการศาสตร์และภาคีเครือข่าย เพื่อนำไปใช้ประโยชน์กับชุมชน ท้องถิ่นอย่างเป็นรูปธรรม\n3. สร้างกิจกรรมและเครือข่ายความร่วมมือด้านกิจกรรมนักศึกษา ที่เน้นจิตอาสาและกระบวนการทางวิศวกรสังคม\n4. บริหาร จัดการคณะวิทยาศาสตร์และเทคโนโลยีได้อย่างมีประสิทธิภาพด้วยหลัก ธรรมาภิบาล โปร่งใส ตรวจสอบได้และพร้อมรองรับการเปลี่ยนแปลงเพื่อประโยชน์ของส่วนรวม\n5. พัฒนาระบบเทคโนโลยีสารสนเทศให้ทันสมัยและพร้อมใช้งาน เป็นฐานข้อมูลสำหรับการวางแผนและพัฒนาในด้านต่างๆ ของคณะวิทยาศาสตร์และเทคโนโลยี\n6. สร้างรายได้ให้กับคณะวิทยาศาสตร์และเทคโนโลยี ทั้งบุคลากรและนักศึกษา โดยความร่วมมือของทุกภาคส่วน ทั้งที่ดำเนินการได้เองภายในคณะ ร่วมกับหน่วยงานในมหาวิทยาลัยและองค์กรภายนอก\n7. มีแนวทางในการประชาสัมพันธ์และการรับนักศึกษา ที่ชัดเจน เข้าถึงกลุ่มเป้าหมาย โดยอาศัยภาคีเครือข่ายและศิษย์เก่า", 'textarea', 'about', 'พันธกิจ'],
            ['policy_th', "1. ด้านการเรียน การสอน และผลิตบัณฑิต\n2. ด้านการวิจัย บริการวิชาการ และพันธกิจสัมพันธ์\n3. ด้านกิจการนักศึกษา และทำนุบำรุงศิลปวัฒนธรรม\n4. ด้านการบริหารจัดการองค์กร\n5. ด้านการพัฒนาระบบเทคโนโลยีสารสนเทศ\n6. ด้านการสร้างรายได้\n7. ด้านการประชาสัมพันธ์และการรับนักศึกษา", 'textarea', 'about', 'นโยบาย'],
            ['strategy_title_th', 'ยุทธศาสตร์ในการบริหารคณะวิทยาศาสตร์และเทคโนโลยีระยะ 4 ปี (พ.ศ. 2565-2569)', 'text', 'about', 'หัวข้อยุทธศาสตร์'],
            ['strategy_1_th', 'ยุทธศาสตร์ที่ 1 ผลิตบัณฑิต พัฒนานักศึกษาและศิษย์เก่าสัมพันธ์', 'text', 'about', 'ยุทธศาสตร์ที่ 1'],
            ['strategy_2_th', 'ยุทธศาสตร์ที่ 2 พัฒนาหลักสูตรและการจัดการเรียนการสอน', 'text', 'about', 'ยุทธศาสตร์ที่ 2'],
            ['strategy_3_th', 'ยุทธศาสตร์ที่ 3 วิจัย บริการวิชาการ และพันธกิจสัมพันธ์', 'text', 'about', 'ยุทธศาสตร์ที่ 3'],
            ['strategy_4_th', 'ยุทธศาสตร์ที่ 4 บริหารจัดการองค์กรที่ดี', 'text', 'about', 'ยุทธศาสตร์ที่ 4'],
            ['strategy_5_th', 'ยุทธศาสตร์ที่ 5 พัฒนาบุคลากร', 'text', 'about', 'ยุทธศาสตร์ที่ 5'],
            ['strategy_6_th', 'ยุทธศาสตร์ที่ 6 สืบสานประเพณี ทำนุบำรุงศิลปวัฒนธรรม ถ่ายทอดภูมิปัญญาท้องถิ่นและโครงการอันเนื่องมาจากพระราชดำริ', 'text', 'about', 'ยุทธศาสตร์ที่ 6'],
            ['strategy_7_th', 'ยุทธศาสตร์ที่ 7 จัดหารายได้', 'text', 'about', 'ยุทธศาสตร์ที่ 7'],
            ['strategy_8_th', 'ยุทธศาสตร์ที่ 8 การประชาสัมพันธ์และการรับนักศึกษา', 'text', 'about', 'ยุทธศาสตร์ที่ 8'],
        ];
