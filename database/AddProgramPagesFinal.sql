-- Final migration for curriculum website system
-- Run: mysql -u root newscience < database/AddProgramPagesFinal.sql
...
INSERT IGNORE INTO program_pages (program_id, slug, is_published, created_at, updated_at)
SELECT 
    id, 
